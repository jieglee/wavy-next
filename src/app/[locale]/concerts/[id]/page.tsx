...
<Navbar sticky={false} />
        <div className="mx-auto max-w-[1440px] px-2 py-16 text-center sm:px-4 lg:px-6">
          <div className="h-10 w-10 animate-spin rounded-full border-4 border-[#1E40AF] border-t-transparent mx-auto" />
        ...
        <div className="mx-auto grid max-w-[1440px] items-center px-2 sm:px-4 lg:grid-cols-[minmax(0,1fr)_520px] lg:gap-4 lg:px-6">
          ...
          <div className="flex items-center justify-between gap-3 px-2 py-3 lg:px-3">
            ...
            <button
              ...
              className="shrink-0 rounded-lg bg-[#1E40AF] px-6 py-3 text-[15px] font-bold text-white transition hover:brightness-110"
            >
              {t("buyTicket")}
            </button>
          </div>
            ...
            <div className="sticky top-[80px]">
              <div className=" bg-white p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#1E40AF]/10 text-[16px] font-bold text-[#1E40AF]">
