...
const WavyIcon = ({ size = 26 }: { size?: number }) => (
  <svg
    ...
    viewBox="0 0 200 200"
    role="img"
    aria-label="Wavy icon"
    className="shrink-0"
  >
    <rect x="0" y="0" width="200" height="200" rx="36" fill="#F7F4EF" />
    <path
      d="M53,120 C65,72 75,72 85,100 C95,128 105,128 115,100 C125,72 135,72 147,120"
      fill="none"
      stroke="#1D1B24"
      strokeWidth="7"
      strokeLinecap="round"
    ...
    />
    <circle cx="75" cy="72" r="6" fill="#E63950" />
  </svg>
);
