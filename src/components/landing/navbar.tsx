...
const WavyIcon = ({ scrolled = false, size = 26 }: { scrolled?: boolean; size?: number }) => (
  <svg
  ...
  >
    <path
      d="M3 15 Q6 8, 9 15 T15 15 T21 15"
      stroke={scrolled ? "#FF5470" : "#FF5470"}
      strokeWidth="2.2"
      strokeLinecap="round"
      fill="none"
    />
        ...
        <nav
          className={cn(
            ...
            scrolled
              ...
              : "w-full max-w-300 rounded-2xl pl-4 pr-2 bg-wavy-bg/80 shadow-[0_4px_24px_rgba(0,0,0,0.25)]"
          )}
        >
          <Link href="/" className="flex items-center gap-2 no-underline shrink-0 mr-1">
            <WavyIcon scrolled={scrolled} size={24} />
