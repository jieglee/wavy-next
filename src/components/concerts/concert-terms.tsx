  ...
  return (
    <section ref={ref} id="sec-terms" className="scroll-mt-[72px]">
      <div className="flex items-center gap-2">
        ...
        <h2 className="font-[var(--font-inter)] text-[14px] font-bold text-[#111827]">{t("title")}</h2>
      </div>
