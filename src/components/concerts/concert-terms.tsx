...
const ConcertTerms = forwardRef<HTMLDivElement, { terms: string; concertId?: number | string }>(({ terms }, ref) => {
  ...
  return (
    <section ref={ref} id="sec-terms" className="scroll-mt-[140px]">
      ...
      <div className="tnc-terms mt-3 font-sans text-base leading-6 text-gray-800 [&_a]:text-rose-500 [&_a]:underline [&_em]:!text-rose-500" dangerouslySetInnerHTML={{ __html: sanitizeHtml(terms) }} />
    </section>
  );
});
