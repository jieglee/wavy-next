    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="grid w-full grid-cols-1 items-center gap-4 lg:grid-cols-[minmax(0,1fr)_520px] lg:items-start lg:gap-4">
          ...
          <div className="relative z-10 hidden h-[460px] w-[520px] translate-y-[-160px] items-end justify-end justify-self-end self-end overflow-hidden rounded-t-xl pr-2 shadow-xl lg:flex">
            <img
              src={banner}
              alt={concert.title}
