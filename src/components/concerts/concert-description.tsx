...
const ConcertDescription = forwardRef<HTMLDivElement, { description: string }>(({ description }, ref) => {
  ...
  return (
    <section ref={ref} id="sec-desc" className="scroll-mt-[72px]">
      <div className="font-sans text-justify text-[15px] leading-6 text-black [&_a]:text-black [&_a]:underline [&_em]:text-black [&_em]:not-italic" dangerouslySetInnerHTML={{ __html: html }} />
    </section>
  );
});
